...
//getting all the order's as possible
...
router.put('/:id', async (req,res) => {
    ...
    if(!order)
       return res.status(400).json({message: 'the order you want to update does not exist'})
...
router.get(`/get/count`, async(req,res) => {
    ...
    const orderCount = await Order.countDocuments();
     if(!orderCount)
        ...
        console.log(`The total product is`,orderCount);
